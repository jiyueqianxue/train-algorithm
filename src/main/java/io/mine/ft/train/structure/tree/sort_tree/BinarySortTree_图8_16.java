...
public class BinarySortTree_图8_16<T extends Comparable<? super T>>
{
    public TriNode<T> root;                                //根结点，三叉链表结点结构

    public BinarySortTree_图8_16()                                //构造空二叉排序树
    {
        this.root=null;
    }
    public BinarySortTree_图8_16(T[] values)                      //构造二叉排序树，由values数组提供元素
    {
        this();                                            //构造空二叉排序树
